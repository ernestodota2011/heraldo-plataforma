...
- Los datos que no son tabla se descubren por las constantes de prefijo del código, y el generador se niega a escribir si alguna no tiene fila. Ese descubrimiento reconoce las constantes por su nombre: una familia de claves que no lo siguiera quedaría fuera, y por eso el nombre es convención del repositorio y no criterio de quien la escribe.
